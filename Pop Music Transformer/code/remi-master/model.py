...
class PopMusicTransformer(object):
    ...
    def extract_events(self, input_path):
        ...
        self.debug_note_items = note_items
        self.debug_tempo_items = tempo_items
        note_items = utils.quantize_items(note_items)
        self.debug_note_items_ = note_items
        max_time = note_items[-1].end
        if 'chord' in self.checkpoint_path:
            chord_items = utils.extract_chords(note_items)
            self.debug_chord_items = chord_items
            items = chord_items + tempo_items + note_items
            self.debug_final_items = items
        else:
    ...
    def prepare_data(self, midi_paths):
        ...
        # event to word
        self.debug_all_events = all_events
        all_words = []
        ...
        self.debug_all_words = all_words
        # to training data
        self.group_size = 5
        segments = []
        ...
        for e in range(200):
            ...
            for i in range(num_batches):
                ...
                for j in range(self.group_size):
                    ...
                    batch_loss_history.append(loss_)
